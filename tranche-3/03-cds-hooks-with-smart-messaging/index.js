...
async function authenticateEHR (req, res, next) {
  ...
  const isWhitelisted = whitelistedEHRs.find(ehr => ehr === iss);
...
<html>
<head>
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/Vermonster/fhir-kit-smart-messenger@latest/dist/index.min.js"></script>
